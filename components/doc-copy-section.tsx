...
export function DocCopySection({ content, url }: DocCopySectionProps) {
  ...
  return (
    <Popover>
      <div className="hidden md:inline-flex -space-x-px rounded-md shadow-xs rtl:space-x-reverse mr-2">
        <Button
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild className="hidden sm:flex">
            <Button
              className="rounded-l-none size-8 shadow-none first:rounded-s-md last:rounded-e-md focus-visible:z-10"
              variant="secondary"
              size="icon"
